...
import net.minecraft.server.v1_9_R3.NBTBase;
import net.minecraft.server.v1_9_R3.NBTTagCompound;
import net.minecraft.server.v1_9_R3.NBTTagList;

import org.bukkit.craftbukkit.v1_9_R3.inventory.CraftItemStack;
...
public class Attributes {
	public static ItemStack hideFlags(ItemStack stack, int value)
    {
    	net.minecraft.server.v1_9_R3.ItemStack nmsStack = CraftItemStack.asNMSCopy(stack);
    	NBTTagCompound tc = nmsStack.getTag();
    	tc.setInt("HideFlags", value);
    	nmsStack.setTag(tc);
    ...
    public net.minecraft.server.v1_9_R3.ItemStack nmsStack;
